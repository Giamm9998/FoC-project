...
\begin{figure}
    ...
    \begin{msc}{}
        ...
        \mess{$upload\_chunk, E(fc_0, K), Tag(upload\_file \mid\mid seq + 2, K)$}{client}{server}
        \nextlevel[2]
        \mess{$\dots$}{client}{server}
        \nextlevel[2]
        \mess{$upload\_end, E(fc_i, K), Tag(upload\_file \mid\mid seq + 2 + i, K)$}{client}{server}
        ...
        \nextlevel[4]
        \mess{$upload\_res, E(m_2, K), Tag(upload\_res \mid\mid seq + 3, K)$}{server}{client}
        \nextlevel
    \end{msc}
    \centering
    \caption{File upload}
...
\begin{figure}
    ...
    \begin{msc}{}
        ...
        \nextlevel[5]
        \mess{$download\_chunk, E(fc_0, K), Tag(download\_ans \mid\mid seq + 1, K)$}{server}{client}
        \nextlevel[2]
        \mess{$\dots$}{server}{client}
        \nextlevel[2]
        \mess{$download\_end, E(fc_i, K), Tag(download\_ans \mid\mid seq + 1 + i, K)$}{server}{client}
