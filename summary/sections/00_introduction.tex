...
\begin{figure}
    ...
    \begin{bytefield}[bitwidth=0.5em]{64}
        \bitheader[]{64, 56, 48, 40, 32, 24, 16, 8, 0} \\
        \bitbox{8}[bgcolor=lightgreen]{Type} & \bitbox{24}{Payload length}
        \bitbox{32}[bgcolor=lightgreen]{Sequence number} \\
        \wordbox[lrt]{1}[bgcolor=lightgreen]{IV} \\
        \bitbox[lrb]{32}[bgcolor=lightgreen]{} & \bitbox[lrt]{32}[bgcolor=lightred]{} \\
